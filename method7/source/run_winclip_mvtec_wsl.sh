#!/usr/bin/env bash
# Reproduce WinCLIP's MVTec AD zero- and few-normal-shot protocols in WSL.
# Usage: bash run_winclip_mvtec_wsl.sh [zero|one|two|four|all]
set -euo pipefail
...
RESULT_ROOT="/mnt/c/Users/test/Desktop/Codex/lab-m5hfg/method7/source/results/winclip_mvtec"
...
case "${MODE}" in
  ...
  all)
    ...
    ;;
  *)
    echo "Usage: $0 [zero|one|two|four|all]" >&2
    exit 2
    ;;
esac
