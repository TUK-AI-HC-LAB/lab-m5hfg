...
### 실험 4: WinCLIP의 MVTec AD와 VisA target 비교

#### 질문

- 동일한 WinCLIP 설정에서 target dataset을 MVTec AD와 VisA로 바꾸면 zero/few-normal-shot 결과는 어떻게 달라지는가?
...
- raw CSV: `method7/source/results/winclip_mvtec/*/results.csv`, `method7/source/results/winclip_visa/*/results.csv`.

#### 실제 결과

| Condition | MVTec Pixel AUROC (%) | VisA Pixel AUROC (%) | MVTec AUPRO (%) | VisA AUPRO (%) | MVTec Image AUROC (%) | VisA Image AUROC (%) |
|---|---:|---:|---:|---:|---:|---:|
| WinCLIP 0-shot | 82.3 | 73.2 | 61.9 | 51.0 | 90.4 | 75.5 |
| WinCLIP+ 1-shot | 93.6 | 94.7 | 84.1 | 80.5 | 93.7 | 83.8 |
| WinCLIP+ 2-shot | 93.8 | 95.1 | 84.8 | 81.2 | 93.7 | 83.4 |
| WinCLIP+ 4-shot | 94.2 | 95.2 | 85.4 | 81.4 | 95.3 | 84.1 |
